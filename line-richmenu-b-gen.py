...
OUT_PATH = os.path.join(BASE, "line-richmenu-b-final.png")
...
# handoff §6-3 リッチメニューB（査定中〜訪問確定後）。3列×2段。
CELLS = [
    {"label": "写真を追加する", "sub": "別の角度・別の台も", "dark": True, "icon": "camera"},
    {"label": "台数を追加する", "sub": "もう1台も一緒に", "icon": "bicycle"},
    {"label": "進捗を確認", "sub": "いまの状況を確認", "icon": "pin"},
    {"label": "日程を変更したい", "sub": "訪問日の調整", "icon": "truck"},
    {"label": "担当者に相談", "sub": "質問・その他はこちら", "icon": "chat"},
    {"label": "キャンセル・やめる", "sub": "今回は見送る", "icon": "house"},
]
