...
TEXT_FIX = {
    # 原画を拡大して文字の帯を測った（2026-09-22）。帯は細く、タイヤの黒い側面・バッテリーの黒い面の中に収める
    '3345': [('rect', (751, 236), (112, 26), 39), ('rect', (210, 772), (106, 26), 51)],   # KENDA ×2（タイヤの側面、斜め）
    '3348': [('rect', (411, 853), (278, 30), -78)],                                      # BRIDGESTONE LITHIUM-ION BATTERY B400（縦、12度傾き）
}
